...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2013 at 01:35 AM
...
--
-- Table structure for table `tbl_currentorder`
--

CREATE TABLE IF NOT EXISTS `tbl_currentorder` (
  `Drink_Name` varchar(50) NOT NULL,
  `Table_Number` int(2) DEFAULT NULL,
...
(16, 'Surly', 'Like Hops? You’ll like this fire-hued beer. This is the beer I have always dreamed of making', 5.0, 'Domestic', 4.50);
